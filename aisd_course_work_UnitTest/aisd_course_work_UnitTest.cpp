...
#include "../aisd_course_work1/Course_work.h"

using namespace Microsoft::VisualStudio::CppUnitTestFramework;

namespace Course_work_UnitTest {
	TEST_CLASS(Course_work_UnitTest) {
...
public:
	TEST_METHOD(TestMethod1) {
...

		{
			...
			if (V.at(0) != 'S')
				throw invalid_argument("Error! Graph should start with 'S'-vertex!");

			if (V.at(V.get_size() - 1) != 'T')
				throw invalid_argument("Error! Graph should finish with 'T'-vertex!");
	...
	TEST_METHOD(TestMethod2) {
		...
		{
			ifstream file("graph_for_unit_test_1.txt");
			if (!file.is_open())
				throw runtime_error("Error! File was not found!");
			int symb_num = 0;
			char symb;
